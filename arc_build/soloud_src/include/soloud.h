...
#define SOLOUD_VERSION 20260203
...
namespace SoLoud
{
	...
	public:
		...
		int findFreeVoice_internal(float priority, int concurrentGroupId, int maxConcurrent, float minConcurrentPlaytime, float volume);
